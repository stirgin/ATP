...
(function($) {
    ...
    function _1d(e) {
    	...
    	//console.log($(e.target)[0].attr('node-id'));
        _11(e);
...
(function($) {
    ...
    ;
    function _9d(tree) {
        var object = $.data(tree, "tree").options;
        var object2 = $.data(tree, "tree").tree;
        $("div.tree-node", object2).unbind(".tree").bind("dblclick.tree", function() {
        	console.log('dblclick');
            _144(tree, this);
            object.onDblClick.call(tree, _128(tree));
        }).bind("click.tree", function() {
            _144(tree, this);
            object.onClick.call(tree, _128(tree));
            ...
            object.onContextMenu.call(tree, e, _c8(tree, this));
        });
        $("span.tree-hit", object2).unbind(".tree").bind("click.tree", function() {
            var _a1 = $(this).parent();
            _108(tree, _a1[0]);
            return false;
        }).bind("mouseenter.tree", function() {
        ...
        $("span.tree-checkbox", object2).unbind(".tree").bind("click.tree", function() {
            var _a2 = $(this).parent();
            _bf(tree, _a2[0], !$(this).hasClass("tree-checkbox1"));
            return false;
        }).bind("mousedown.tree", function() {
            return false;
        });
    ...
    ;
    function addEditField(_14a, _14b) {
    ...
    ;
    function removeEditField(_14f, _150) {
    ...
    $.fn.tree.methods = {options: function(jq) {
            ...
            return jq.each(function() {
                addEditField(this, _16c);
            });
        },endEdit: function(jq, _16d) {
            return jq.each(function() {
                removeEditField(this, _16d);
            });
